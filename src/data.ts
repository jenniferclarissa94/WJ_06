...
export const MOCK_SPOTS: Spot[] = [
  {
    ...
    price_level: 1,
    images: [
      '/assets/Tuku/tuku11.png',
      '/assets/Tuku/tuku1.png',
      '/assets/Tuku/tuku2.png',
      '/assets/Tuku/tuku3.png',
      '/assets/Tuku/tuku4.png',
      '/assets/Tuku/tuku5.png',
      '/assets/Tuku/tuku6.png',
      '/assets/Tuku/tuku7.png',
      '/assets/Tuku/tuku8.png',
      '/assets/Tuku/tuku9.png',
      '/assets/Tuku/tuku10.png',
      '/assets/Tuku/tuku12.png',
      '/assets/Tuku/tuku13.png',
      '/assets/Tuku/tuku14.png',
      '/assets/Tuku/tuku15.png',
      '/assets/Tuku/tuku16.png',
      '/assets/Tuku/tuku17.png'
    ],
    ambiance_images: [
      '/assets/Tuku/tuku1.png',
      '/assets/Tuku/tuku2.png',
  ...
  },
  {
    ...
    price_level: 3,
    images: [
      '/assets/Plataran/pla20.png',
      '/assets/Plataran/pla1.png',
      '/assets/Plataran/pla2.png',
      '/assets/Plataran/pla3.png',
      '/assets/Plataran/pla4.png',
      '/assets/Plataran/pla5.png',
      '/assets/Plataran/pla6.png',
      '/assets/Plataran/pla7.png',
      '/assets/Plataran/pla8.webp',
      '/assets/Plataran/pla9.webp',
      '/assets/Plataran/pla10.webp',
      '/assets/Plataran/pla11.webp',
      '/assets/Plataran/pla12.webp',
      '/assets/Plataran/pla13.webp',
      '/assets/Plataran/pla14.webp',
      '/assets/Plataran/pla15.webp',
      '/assets/Plataran/pla16.webp',
      '/assets/Plataran/pla17.webp',
      '/assets/Plataran/pla18.webp',
      '/assets/Plataran/pla19.webp',
      '/assets/Plataran/pla21.png',
      '/assets/Plataran/pla22.png',
      '/assets/Plataran/pla23.png',
      '/assets/Plataran/pla24.png',
      '/assets/Plataran/pla25.png',
      '/assets/Plataran/pla26.png',
      '/assets/Plataran/pla27.png',
      '/assets/Plataran/pla28.png',
      '/assets/Plataran/pla29.png',
      '/assets/Plataran/pla30.png',
      '/assets/Plataran/pla31.png',
      '/assets/Plataran/pla32.png',
      '/assets/Plataran/pla33.png'
    ],
    ambiance_images: [
      '/assets/Plataran/pla1.png',
      '/assets/Plataran/pla2.png',
  ...
  },
  {
    ...
    price_level: 2,
    images: [
      '/assets/first crack/crack1.webp',
      '/assets/first crack/crack2.webp',
      '/assets/first crack/crack3.webp',
      '/assets/first crack/crack4.webp',
      '/assets/first crack/crack5.webp',
      '/assets/first crack/crack6.webp',
      '/assets/first crack/crack7.webp',
      '/assets/first crack/crack8.webp',
      '/assets/first crack/crack9.webp',
      '/assets/first crack/crack10.webp',
      '/assets/first crack/crack11.webp',
      '/assets/first crack/crack12.webp',
      '/assets/first crack/crack13.webp',
      '/assets/first crack/crack14.webp',
      '/assets/first crack/crack15.webp',
      '/assets/first crack/crack16.webp',
      '/assets/first crack/crack17.webp',
      '/assets/first crack/crack18.webp',
      '/assets/first crack/crack19.webp',
      '/assets/first crack/crack20.webp'
    ],
    ambiance_images: [
      '/assets/first crack/crack2.webp',
      '/assets/first crack/crack3.webp',
  ...
  },
  {
    ...
    price_level: 3,
    images: [
      '/assets/Scarlett/scr3.webp',
      '/assets/Scarlett/scr1.webp',
      '/assets/Scarlett/scr2.webp',
      '/assets/Scarlett/scr4.webp',
      '/assets/Scarlett/scr5.webp',
      '/assets/Scarlett/scr6.webp',
      '/assets/Scarlett/scr7.webp',
      '/assets/Scarlett/scr8.webp',
      '/assets/Scarlett/scr9.webp',
      '/assets/Scarlett/scr10.webp',
      '/assets/Scarlett/scr11.webp',
      '/assets/Scarlett/scr12.webp',
      '/assets/Scarlett/scr13.webp',
      '/assets/Scarlett/scr14.webp',
      '/assets/Scarlett/scr15.webp',
      '/assets/Scarlett/scr16.webp',
      '/assets/Scarlett/scr17.webp',
      '/assets/Scarlett/scr18.webp',
      '/assets/Scarlett/scr19.webp'
    ],
    ambiance_images: [
      '/assets/Scarlett/scr1.webp',
      '/assets/Scarlett/scr2.webp',
...
export const MOCK_NEWS: NewsArticle[] = [
  ...
  },
  {
    ...
    contentBlocks: [
      ...
      { type: 'image', content: '/assets/Glodok/g2.webp' },
      ...
      { type: 'image', content: '/assets/Glodok/g7.jpg' },
      ...
      { type: 'image', content: '/assets/Glodok/g6' },
  ...
  },
  {
    ...
    contentBlocks: [
      ...
      { type: 'image', content: '/assets/demie bakmie.jpeg' }
    ],
  ...
  },
  {
    ...
    contentBlocks: [
      ...
      { type: 'image', content: '/assets/cfd1.jpg' },
      ...
      { type: 'image', content: '/assets/cfd2.webp' },
  ...
  },
  {
    ...
    contentBlocks: [
      ...
      { type: 'image', content: '/assets/TIM1.jpeg' },
      ...
      { type: 'image', content: '/assets/TIM2.jpg' }
    ],
  ...
  },
  {
    ...
    type: 'Deep Dive',
    summary: 'From the bustling alleys of Blok M to serene ateliers in Dharmawangsa, artisanal matcha bars and cult favorites like Matchaman are leading Jakarta\'s newest afternoon obsession.',
    content: 'Specialty green tea sourced directly from Uji and Shizuoka is carving out its own territory across South Jakarta, with Blok M emerging as the vibrant epicenter for modern matcha culture. From Matchaman\'s intense ceremonial brews to minimalist tea ateliers, explore where Jakartans are finding serene midday resets.',
    contentBlocks: [
      { type: 'text', content: 'For over a decade, South Jakarta has lived and breathed third-wave coffee. But over recent months, a vibrant revolution has taken root across the capital\'s trendiest enclaves: artisanal matcha and specialty Japanese tea bars.' },
      { type: 'heading', content: 'Blok M: The Epicenter of the Matcha Wave' },
      { type: 'text', content: 'Nowhere is this green tea movement more palpable than in Blok M (Melawai). Long known as Little Tokyo for its izakayas and noodle bars, Blok M has seamlessly transitioned into Jakarta\'s undisputed matcha capital, where traditional Japanese tea-making crafts blend with South Jakarta\'s vibrant street culture.' },
      { type: 'heading', content: 'The Cult of Matchaman' },
      { type: 'text', content: 'At the forefront of the Blok M sensation is Matchaman. With its eye-catching aesthetic and uncompromising devotion to top-tier ceremonial grade powder, Matchaman has attracted lines of dedicated enthusiasts. Their iced ceremonial matcha latte delivers an intensely rich, vibrant emerald green pour with profound umami and velvety sweetness without relying on excess syrup. Pair it with their signature matcha soft serve or freshly baked pastries for the quintessential Blok M afternoon treat.' },
      { type: 'image', content: '/assets/Matcha.jpg' },
      { type: 'heading', content: 'Single-Origin Cultivars & The Art of the Whisk' },
      { type: 'text', content: 'Unlike commercial powdered drinks loaded with artificial coloring, South Jakarta\'s dedicated tea ateliers treat green tea with the solemnity of fine wine. Patrons can explore single-cultivar harvests such as Okumidori, Samidori, and Yabukita sourced directly from master growers in Uji, Kyoto, and Shizuoka. Each bowl is meticulously weighed, sifted, and whisked to order with a bamboo chasen at precise water temperatures to release its natural vegetal sweetness and creamy crema.' },
      { type: 'image', content: '/assets/Matcha1.jpg' },
      { type: 'heading', content: 'Where to Explore in Blok M & Beyond' },
      { type: 'text', content: 'Beyond Matchaman, explore the hidden gems dotting Melawai and neighboring Panglima Polim. Spots like Ocha Studio serve chilled ceremonial shots paired with citrusy yuzu madeleines, while minimalist spaces in Dharmawangsa offer peaceful tatami booths designed for mindful sipping.' },
      { type: 'text', content: 'Whether you are an experienced matcha purist chasing deep seaweed and umami notes or simply seeking a gentle, sustained l-theanine energy boost without the caffeine jitters, South Jakarta\'s tea bars offer an irresistible afternoon ritual.' }
    ],
  ...
  },
  {
    ...
    content: 'Long after the initial culinary hype subsided, Pasar Santa\'s second floor has matured into a thriving enclave of passionate collectors. From Japanese pressed jazz records and refurbished 35mm cameras to curated vintage apparel, here is where to look.',
    contentBlocks: [
      ...
      { type: 'image', content: '/assets/santa2.webp' },
      ...
      { type: 'image', content: '/assets/santa3.webp' },
      { type: 'heading', content: '3. Curated Vintage Apparel & Band Tees' },
      { type: 'text', content: 'Hidden among the kiosks on the upper floor are specialized thrift boutiques. Unlike massive flea markets where you need hours to sift through unwashed piles, these stalls curate and launder each piece—from authentic 90s rock tour t-shirts and single-stitch graphics to rugged workwear jackets and classic denim.' },
      { type: 'image', content: '/assets/santa4.jpg' }
    ],
    image: '/assets/santa1.jpg',
    date: '2026-07-18',
    author: 'Rian Pratama'
  },
  {
    ...
    content: 'As the humid afternoon transitions into evening, there is nothing quite like watching the Sudirman skyline transition from dusk to twilight. Here are the premier vantage points for aperitifs and city vistas, featuring Henshin, KITA Bar, and Chao Chao.',
    contentBlocks: [
      { type: 'text', content: 'As the humid afternoon transitions into evening, there is nothing quite like watching the Sudirman skyline transition from warm amber into illuminated glass towers. Finding the right high-altitude terrace makes all the difference for a memorable golden hour.' },
      { type: 'heading', content: 'Vantage Points Above the Skyline' },
      { type: 'heading', content: '1. Henshin Restaurant & Bar' },
      { type: 'text', content: 'Perched on the 67th through 69th floors of The Westin Jakarta, Henshin stands as the city\'s highest rooftop destination. Its soaring open-air terrace offers breathtaking 360-degree vistas across the metropolitan expanse, complemented by vibrant Nikkei culinary offerings and precision craft cocktails.' },
      { type: 'image', content: '/assets/h4.jpg' },
      { type: 'heading', content: '2. KITA Bar' },
      { type: 'text', content: 'Occupying the 36th floor of Park Hyatt Jakarta in Menteng, KITA Bar provides an effortlessly stylish sanctuary above central Jakarta. The open-air lounge overlooks the Monas landmark and city skyline, setting the mood with sunset DJ sets and artisanal Japanese-inspired mixology.' },
      { type: 'image', content: '/assets/KITA.jpeg' },
      { type: 'heading', content: '3. Chao Chao Jakarta' },
      { type: 'text', content: 'Nestled on the rooftop of Alila SCBD, Chao Chao combines contemporary Chinese dining with a sleek, high-energy outdoor terrace. Positioned right in the heart of SCBD, it gives you an intimate front-row seat to Jakarta\'s gleaming glass towers as dusk transitions into vibrant nightlife.' },
      { type: 'image', content: '/assets/Chao.jpg' }
    ],
  ...
  {
    id: 'n10',
    title: 'Jakarta Unique Architecture',
    type: 'Deep Dive',
    summary: 'From tropical brutalist experiments to Art Deco heritage and soaring postmodern spires, explore 5 of Jakarta\'s most audacious and distinctive architectural marvels.',
    content: 'Jakarta\'s skyline is often painted with generic glass towers, but look closer and you will discover an eclectic architectural playground. From Paul Rudolph\'s tropical brutalist terraces to the historic Art Deco curves of Metropole, here are 5 unique buildings that define the capital\'s visual identity.',
    contentBlocks: [
      { type: 'text', content: 'Jakarta is a living architectural palimpsest—where mid-century post-colonial ambition, bold tropical climate experiments, and audacious contemporary forms collide. Beyond standard glass office blocks, the city boasts remarkable structures that celebrate geometry, local climate, and cultural symbolism.' },
      { type: 'heading', content: '1. Wisma 46 (The Fountain Pen)' },
      { type: 'text', content: 'Rising 262 meters above Sudirman, Wisma 46 designed by Zeidler Roberts Partnership and DP Architects is Jakarta\'s most recognizable postmodern silhouette. Completed in 1996, its graceful curved turquoise glass facade culminates in a soaring needle-like peak, earning it the affectionate moniker "Gedung Pulpen" (The Fountain Pen). Its nautical curves and aerodynamic form broke away from standard rectangular towers, creating an eternal icon on the capital\'s horizon.' },
      { type: 'image', content: '/assets/arch/46.jpg' },
      { type: 'heading', content: '2. Intiland Tower (Tropical Brutalism by Paul Rudolph)' },
      { type: 'text', content: 'Formerly known as Wisma Dharmala Sakti, this 23-story icon designed by legendary modernist architect Paul Rudolph is a masterclass in climate-responsive tropical brutalism. Completed in 1986, the building eschews curtain glass walls in favor of dramatic 45-degree angled overhangs (brise-soleil), cascading stepped terraces, and an open-air central courtyard. Lush green plants spill over raw concrete spandrels, creating natural shade and chimney-effect passive cooling.' },
      { type: 'image', content: '/assets/arch/inti.jpg' },
      { type: 'heading', content: '3. Bakrie Tower (The Kinetic Twist)' },
      { type: 'text', content: 'Located in the Rasuna Epicentrum complex in Kuningan, Bakrie Tower is one of Jakarta\'s most dynamic contemporary engineering feats. Designed by global architecture firm HOK, the 50-story tower twists asymmetrically as it rises, with floor plates subtly shifting and cantilevering every few levels. The resulting silhouette gives the building an illusion of perpetual motion and fluid kinetic energy, reflecting dramatic sunset hues across its faceted blue glass panels.' },
      { type: 'image', content: '/assets/arch/bakrie2.jpg' },
      { type: 'heading', content: '4. Metropole XXI (Art Deco Splendor)' },
      { type: 'text', content: 'Standing proudly at the corner of Jalan Diponegoro and Pegangsaan in Menteng, the Metropole building (formerly Bioscoop Metropole and Megaria) is Jakarta\'s oldest surviving Art Deco cinema and a registered cultural heritage landmark. Designed by architects Liauw Goan Sing and Johannes Martinus Groenewegen and opened in 1951, it showcases quintessential Streamline Moderne and Art Deco elegance: an asymmetrical stepped central spire, horizontal banding, porthole windows, and sleek rounded curves that evoke the golden age of cinema in post-independence Indonesia.' },
      { type: 'image', content: '/assets/arch/metropole.jpg' },
      { type: 'heading', content: '5. Istiqlal Mosque (Monumental Sacred Modernism)' },
      { type: 'text', content: 'Designed by Christian architect Friedrich Silaban following a national competition held by President Sukarno, Istiqlal is a monumental triumph of modernist sacred architecture. Built with white Indonesian marble and monumental geometric colonnades, the mosque features a breathtaking 45-meter-wide central stainless steel sphere dome and a soaring 96-meter minaret. The vast prayer hall relies on open-air lattice screens (kerawang) for natural cross-ventilation, embodying both spiritual majesty and progressive mid-century Indonesian identity.' },
      { type: 'image', content: '/assets/arch/istiqlal2.webp' }
    ],
    image: '/assets/arch/southq.jpg',
    date: '2026-06-28',
    author: 'Kelvin Lee'
  }
];
