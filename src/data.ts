...
export const MOCK_SPOTS: Spot[] = [
  ...
  },
  {
    ...
    price_level: 3,
    images: [
      'https://images.unsplash.com/photo-1542314831-c6a4d14eb508?auto=format&fit=crop&w=600&q=80',
      'https://images.unsplash.com/photo-1579738012693-db19f4a66a1a?auto=format&fit=crop&w=600&q=80'
    ],
    love_count: 890,
    distance_km: 0.5,
    tags: ['late-night'],
